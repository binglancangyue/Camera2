...
public class Storage {
    ...
    public static final String DIRECTORY = V66_DCIM + "/Camera";//"/sdcard/DCIM/Camera";//for test//
    public static final String DIRECTORY_BACK = "sdcard/DCIM/Camera";//for test//
    ...
    public static void formatSDcard(Context context) {
		...
		Log.i(TAG, "########SD1 Format, "+storageVolumes[1].toString());
