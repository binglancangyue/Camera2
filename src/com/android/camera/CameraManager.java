...
//todo
//import android.hardware.Camera.AWMoveDetectionListener;
...
public interface CameraManager {
    ...
    public interface CameraAFCallback {
        public void onAutoFocus(boolean focused, CameraProxy camera);   //自动对焦
    }
    ...
    public interface CameraAFMoveCallback {
        public void onAutoFocusMoving(boolean moving, CameraProxy camera);  //焦点移动时
    } 
    ...
    public interface CameraShutterCallback {
        public void onShutter(CameraProxy camera); //拍照获取照片时主要用来播放一个声音或者其他操作用来提示用户已经获取到图片的数据
    }
    ...
    public interface CameraPreviewDataCallback {
        public void onPreviewFrame(byte[] data, CameraProxy camera);   //相机预览
    }
    ...
    public interface CameraFaceDetectionCallback {
         ...
         */
        public void onFaceDetection(Camera.Face[] faces, CameraProxy camera); //对人脸检测的监听
    }

	/* adas start */
    /**
     * An interface which wraps
     * {@link android.hardware.Camera.AdasDetectionListener}.
     */
    public interface CameraAdasDetectionCallback {
        /**
         * Callback for adas detection.
         *
         * @param adas   Recognized adas in the preview.
         * @param camera  The camera which the preview image comes from.
         */
        public void onAdasDetection(/*Camera.Adas adas, */CameraProxy camera);
    }
	/* adas end */
    
    /* AWMoveDetection start */
    public interface CameraAWMoveDetectionCallback {
        /**
         * Callback for move detection.
         *
         * @param adas   Recognized move detection in the preview.
         * @param camera  The camera which the preview image comes from.
         */
    	public void onAWMoveDetection(int value, CameraProxy camera);
    }
    /* AWMoveDetection end */
    ...
    public interface CameraProxy {
        ...
        /**
         * Starts the Adas detection.
         */
        public void startAdasDetection();

        /**
         * Stops the Adas detection.
         */
		...
		public void setWaterMarkMultiple(String markInfo);
